...
const actions = [
  ...
  { icon: '💊', title: 'Refill Prescription', desc: 'Request a refill for meds', path: '/refill-prescription' },
  { icon: '💰', title: 'Pay Bills', desc: 'View and pay your medical bills', path: '/pay-bills' },
];
